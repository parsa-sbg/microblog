        ...
        <div className={`${isModalOpen && '!flex'} hidden fixed top-0 bottom-0 left-0 right-0 items-center justify-center`}>
            ...
            <div className='bg-bglight dark:bg-bgdark flex flex-col justify-between w-full h-full md:max-w-96 md:h-fit md:gap-5 md:border border-secondarydark md:rounded-md p-3 z-50'>
                ...
                <form className='flex flex-col gap-2 h-full'>
                    <input className='w-full bg-transparent border border-main transition-all focus:border-mainlight rounded-md py-2 px-3 outline-none' placeholder='old password' type="text" />
                    <input className='w-full bg-transparent border border-main transition-all focus:border-mainlight rounded-md py-2 px-3 outline-none' placeholder='new password' type="text" />
                </form>
                ...
                <div className='flex justify-center gap-3'>
                    ...
                    <button className={`mini-h-full flex justify-center items-center max-w-52 w-full py-2 px-5 text-xl bg-mainlight rounded-md`}>
