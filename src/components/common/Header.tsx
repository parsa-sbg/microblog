        ...
        <div className='fixed left-0 right-0 top-0 md:rounded-md md:right-3 md:left-3 md:top-1 bg-opacity-30 bg-main min-h-14'>
            <div className='container py-2 px-4 flex justify-between items-center gap-2'>
                ...
                {user ? (
                    ...
                    // login / register btns
                    <div>
                        <Link href={'/signin'} className=' inline-block transition-all hover:scale-105 hover:-translate-x-0.5 font-bold bg-gray-300 rounded-l-full p-2 mr-0.5'>sign in</Link>
                        <Link href={'/signup'} className=' inline-block transition-all hover:scale-105 hover:translate-x-0.5 font-bold bg-gray-300 rounded-r-full p-2'>sign up</Link>
                    </div>
                )}
